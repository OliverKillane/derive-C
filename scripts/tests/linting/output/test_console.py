import pytest
from src.linting.linter import ResultSingle, ResultMultiple, LintResults, LinterCheck, Error, LintContext, Result
...
def test_console_output_format():
    ...
    result3 = ResultMultiple(results={
