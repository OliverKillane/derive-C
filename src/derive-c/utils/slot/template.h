...
INTERNAL static void NS(SELF, memory_tracker_empty)(SELF const* slot) {
...
INTERNAL static void NS(SELF, set_empty)(SELF* slot, SLOT_INDEX_TYPE next_free) {
    NS(SELF, memory_tracker_empty)(slot);
    slot->present = false;
    slot->next_free = next_free;
}

INTERNAL static void NS(SELF, memory_tracker_present)(SELF const* slot) {
...
INTERNAL static void NS(SELF, fill)(SELF* slot, SLOT_VALUE value) {
    NS(SELF, memory_tracker_present)(slot);
    slot->present = true;
    slot->value = value;
}

INTERNAL static void NS(SELF, clone_from)(SELF const* from_slot, SELF* to_slot) {
...
INTERNAL static void NS(SELF, debug)(SELF const* self, dc_debug_fmt fmt, FILE* stream) {
    if (self->present) {
...
INTERNAL static void NS(SELF, delete)(SELF* self) {
    if (self->present) {
