...
#else
    #define REQUIRE_METHOD_EXPR(ret, obj, name, args) _Generic(&NS(obj, name), ret(*) args: 1, default: 0)
    #define REQUIRE_CONSTANT_TYPE_EXPR(obj, name, Type)   _Generic((NS(obj, name)), Type: 1, default: 0)
#endif
