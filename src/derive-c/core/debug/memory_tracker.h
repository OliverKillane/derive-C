...
DC_PUBLIC static void dc_memory_tracker_set(dc_memory_tracker_level level,
...
DC_PUBLIC static void dc_memory_tracker_check(dc_memory_tracker_level level,
...
DC_PUBLIC static void dc_memory_tracker_debug(FILE* stream, const void* addr, size_t size) {
