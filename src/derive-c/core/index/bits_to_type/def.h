        ...
        // JUSTIFY: Larger type is the same
        //  - For int64_t, the exclusive  upper is within uint64_t range, so this is valid
        #define INDEX_LARGER_TYPE uint64_t
