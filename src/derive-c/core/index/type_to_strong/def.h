...
DC_PUBLIC static bool NS(INDEX, eq)(INDEX const* idx_1, INDEX const* idx_2) {
    return idx_1->index == idx_2->index;
}

DC_PUBLIC static void NS(INDEX, debug)(INDEX const* idx, dc_debug_fmt fmt, FILE* stream) {
    (void)fmt;
