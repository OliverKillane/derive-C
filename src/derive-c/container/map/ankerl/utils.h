...
INTERNAL static size_t _dc_ankerl_buckets_capacity(size_t for_items) {
...
INTERNAL static uint8_t _dc_ankerl_fingerprint_from_hash(size_t hash) {
...
INTERNAL static dc_ankerl_dfd _dc_ankerl_dfd_increment(dc_ankerl_dfd dfd) {
    return (dfd == _dc_ankerl_dfd_max) ? _dc_ankerl_dfd_max : (dc_ankerl_dfd)(dfd + 1U);
}

INTERNAL static dc_ankerl_dfd _dc_ankerl_dfd_decrement_for_backshift(dc_ankerl_dfd dfd) {
...
INTERNAL static dc_ankerl_dfd _dc_ankerl_dfd_new(uint8_t distance) {
...
INTERNAL static bool _dc_ankerl_mdata_present(dc_ankerl_mdata const* bucket) {
