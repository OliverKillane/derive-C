...
RC_GTEST_PROP(ContiguousArena, FuzzSmall, ()) {
    ...
    rc::state::check(
        sutModel, sutWrapper,
        rc::state::gen::execOneOfWithArgs<Insert<SutSmall>, Insert<SutSmall>, Write<SutSmall>,
                                          Remove<SutSmall>, Delete<SutSmall>>());
}
...
RC_GTEST_PROP(ContiguousArena, FuzzMedium, ()) {
    ...
    rc::state::check(
        sutModel, sutWrapper,
        rc::state::gen::execOneOfWithArgs<Insert<SutMedium>, Insert<SutMedium>, Write<SutMedium>,
                                          Remove<SutMedium>, Delete<SutMedium>>());
}
